...
SoundInstance::operator=(const SoundInstance &rhs)
{
...
void COMAPI SoundArchetype::get_sound_format(SoundFormat *soundFormat)
{
	memcpy(soundFormat, &m_soundFile.format, sizeof(SoundFormat));
}

U32 COMAPI SoundArchetype::get_samples(void * samples)
{
	samples = m_soundFile.samples;
	return m_soundFile.length;
}

U32 COMAPI SoundArchetype::get_sample_count()
{
	return m_soundFile.length;
}

SINGLE COMAPI SoundArchetype::get_base_attenuation()
{
	return m_baseAttenuation;
}

U32 COMAPI SoundArchetype::get_num_channels()
{
	return m_soundFile.format.num_channels;
}

U32 COMAPI SoundArchetype::get_duration()
{
	return m_msDuration;
}

bool COMAPI SoundArchetype::is_loopable()
{
	return true;
}

void COMAPI SoundArchetype::set_samples(void * samples, U32 length)
{
	memcpy(m_soundFile.samples, samples, length);
}

GENRESULT COMAPI SoundArchetype::set_base_attenuation(SINGLE attenuation)
{
	if (attenuation > 0.0) 
	{
		attenuation = 0.0;
...
DWORD WINAPI SoundManager::loop_notification_thread_loop (LPVOID)
{
	while (true)
	{
		...
		{
			for (itr = m_playList.begin(); itr != m_playList.end(); itr++)
			{
...
GENRESULT COMAPI SoundManager::set_sound_format(SoundFormat *soundFormat)
{
...
GENRESULT COMAPI SoundManager::get_sound_format(SoundFormat *soundFormat)
{
...
GENRESULT COMAPI SoundManager::set_master_attenuation(const SINGLE masterAttenuation)
{
	m_masterAttenuation = masterAttenuation;
	return GR_OK;
}

GENRESULT COMAPI SoundManager::set_maximum_channels(const U32 maxChannels)
{
...
GENRESULT COMAPI SoundManager::set_speaker_configuration(const U32 speakerConfiguration)
{
...
SINGLE COMAPI SoundManager::get_master_attenuation()
{
	return m_masterAttenuation;
}

U32 COMAPI SoundManager::get_maximum_channels()
{
	return m_maxChannels;
}

U32 COMAPI SoundManager::get_speaker_configuration()
{
...
GENRESULT COMAPI SoundManager::set_master_reverb(const U32 baseEnv, const SINGLE vol, const SINGLE decay, const SINGLE damping)
{
...
void COMAPI SoundManager::get_master_reverb(U32 *baseEnv, SINGLE *vol, SINGLE *decay, SINGLE *damping)
{
...
GENRESULT COMAPI SoundManager::set_ear_orientation(const Matrix *orientation)
{	
	return set_ear_orientation(&orientation->get_k(), &orientation->get_j());
}

GENRESULT COMAPI SoundManager::set_ear_orientation(const Vector *back, const Vector * up)
{
...
GENRESULT COMAPI SoundManager::set_ear_position(const Vector *position)
{
...
GENRESULT COMAPI SoundManager::set_ear_velocity(const Vector *velocity)
{
...
GENRESULT COMAPI SoundManager::set_ear_distance_factor(const SINGLE distanceFactor)
{
...
GENRESULT COMAPI SoundManager::set_ear_doppler_factor(const SINGLE dopplerFactor)
{
...
GENRESULT COMAPI SoundManager::set_ear_rolloff_factor(const SINGLE rolloff)
{
...
void COMAPI SoundManager::get_ear_orientation(Matrix *orientation)
{	
	Vector back, up, side;
...
void COMAPI SoundManager::get_ear_orientation(Vector *back, Vector *up)
{
...
Vector COMAPI SoundManager::get_ear_position()
{
...
Vector COMAPI SoundManager::get_ear_velocity()
{
...
SINGLE COMAPI SoundManager::get_ear_distance_factor()
{
	return m_listenerDistanceFactor;
}

SINGLE COMAPI SoundManager::get_ear_doppler_factor()
{
	return m_listenerDopplerFactor;
}

SINGLE COMAPI SoundManager::get_ear_rolloff_factor()
{
	return m_listenerRolloffFactor;
}

GENRESULT COMAPI SoundManager::get_property(ISoundSource *sound, REFGUID propGUID, const U32 propID, void *propData, const U32 sizeOfPropData, U32 * sizeOfDataWritten)
{
...
GENRESULT COMAPI SoundManager::get_global_property(REFGUID propGUID, const U32 propID, void *propData, const U32 sizeOfPropData, U32 * sizeOfDataWritten)
{
	GENRESULT retVal = GR_GENERIC;
...
GENRESULT COMAPI SoundManager::set_property(ISoundSource *sound, REFGUID propGUID, const U32 propID, void *propData, const U32 sizeOfPropData)
{
	GENRESULT retVal = GR_GENERIC;
...
GENRESULT COMAPI SoundManager::set_global_property(REFGUID propGUID, const U32 propID, void *propData, const U32 sizeOfPropData)
{
	GENRESULT retVal = GR_GENERIC;
...
SOUND_ARCH_INDEX COMAPI SoundManager::create_archetype_from_raw_data (const SoundFormat &format, U32 length, U32 loop_start, U32 loop_end, void *sample_buffer, U32 options)
{
...
SOUND_ARCH_INDEX COMAPI SoundManager::create_archetype_from_soundfile (const SoundFile &soundFile, U32 options)
{
	SOUND_ARCH* nu = new DAComponent <SoundArchetype>;
...
SOUND_ARCH_INDEX COMAPI SoundManager::create_archetype (IFileSystem *sourceFile, U32 options)
{
	SOUND_ARCH* nu = new DAComponent <SoundArchetype>;
...
GENRESULT COMAPI SoundManager::destroy_archetype(SOUND_ARCH_INDEX archetype)
{
...
GENRESULT COMAPI SoundManager::get_archetype_interface(SOUND_ARCH_INDEX archetype, void ** archInterface)
{
	if (archInterface)
	{
		SOUND_ARCH* ar;
...
GENRESULT COMAPI SoundManager::add_active_sound (ISoundSource *sound, U32 index)
{
	if (sound)
	{
		U32 currentIndex = 0;
...
GENRESULT COMAPI SoundManager::set_active_sounds (ISoundSource *sounds[], U32 count)
{
...
GENRESULT COMAPI SoundManager::remove_active_sound (ISoundSource *sound)
{
...
U32 COMAPI SoundManager::get_active_sound_count()
{
	// return m_numActiveSounds
	return m_activeSoundList.size();
}

U32 COMAPI SoundManager::get_playing_sound_count()
{
	// return m_numPlayingSounds
	return m_playList.size();
}

GENRESULT COMAPI SoundManager::get_playing_sound_status (int which, SoundStatus &playingStatus)
{
...
GENRESULT COMAPI SoundManager::startup(HWND hWnd, U32 options)
{
	if (!m_Initialized)
		Initialize();
...
GENRESULT COMAPI SoundManager::shutdown()
{
	erase_archetypes ();
...
void COMAPI SoundManager::update(ISoundListener *IEar)
{	
...
void COMAPI SoundManager::get_sound_format(SOUND_ARCH_INDEX archetype, SoundFormat *soundFormat)
{
	SOUND_ARCH* ar;
...
U32 COMAPI SoundManager::get_samples(SOUND_ARCH_INDEX archetype, void * samples)
{
	SOUND_ARCH* ar;
...
U32 COMAPI SoundManager::get_sample_count(SOUND_ARCH_INDEX archetype)
{
	SOUND_ARCH* ar;
...
SINGLE COMAPI SoundManager::get_base_attenuation(SOUND_ARCH_INDEX archetype)
{
	SOUND_ARCH* ar;
...
U32 COMAPI SoundManager::get_num_channels(SOUND_ARCH_INDEX archetype)
{
	SOUND_ARCH* ar;
...
void COMAPI SoundManager::set_samples(SOUND_ARCH_INDEX archetype, void * samples, U32 length)
{
	SOUND_ARCH* ar;
...
bool COMAPI SoundManager::is_loopable(SOUND_ARCH_INDEX archetype)
{
	SOUND_ARCH* ar;
...
GENRESULT COMAPI SoundManager::Initialize()
{
...
GENRESULT SoundManager::initialize_direct_sound()
{
	...
	if (m_lpds)
	{
		...
		if (m_lpdsPrimaryBuffer)
		{
			...
			WAVEFORMATEX fmt={WAVE_FORMAT_PCM,m_primaryNumChannels,m_primarySampleRate,bytesPerSec,blockAlign,m_primaryBitsPerSample,0};
...
{
	U32 position = 1;
	for (InstanceList::iterator itr = checkList.begin(); itr != checkList.end(); itr++)
	{	
                    ...
                    LPVOID    lpvReserved)
{
	...
	switch (fdwReason)
      ...
      case DLL_PROCESS_ATTACH:
			...
			if( (server = new DAComponentFactory2<DAComponentAggregate<SoundManager>, AGGDESC> ("ISoundManager")) != NULL ) {
				if (DACOM_Acquire()->RegisterComponent(server, "ISoundManager", DACOM_LOW_PRIORITY) != GR_OK)
				{
