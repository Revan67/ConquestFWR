// DirectionalLightCustomControlsUI.cpp : implementation file
//
...
DirectionalLightCustomControlsUI::DirectionalLightCustomControlsUI(CWnd* pParent, const CallbackOnChange& callback, ROS::ASceneEntity* sceneEntity)
: TSceneEntityForm(DirectionalLightCustomControlsUI::IDD, pParent, callback, sceneEntity)
{
	Create(DirectionalLightCustomControlsUI::IDD, pParent);
	ShowWindow(SW_SHOWNORMAL);

	//{{AFX_DATA_INIT(DirectionalLightCustomControlsUI)
	//}}AFX_DATA_INIT
}
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::OnPaint() 
{
	BaseClass::OnPaint();
...
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(DirectionalLightCustomControlsUI)
...
//---------------------------------------------------------------------------
BEGIN_MESSAGE_MAP(DirectionalLightCustomControlsUI, CDialog)
	//{{AFX_MSG_MAP(DirectionalLightCustomControlsUI)
...
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
// DirectionalLightCustomControlsUI message handlers
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::UpdateForm()
{
...
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::UpdateColorBitmap(const ROS::Color& color)
{
...
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::OnChangeRedEdit() 
{
...
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::OnChangeGreenEdit() 
{
   ROS::ALight* light = dynamic_cast<ROS::ALight*>(GetSceneEntity());
...
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::OnChangeBlueEdit() 
{
   ROS::ALight* light = dynamic_cast<ROS::ALight*>(GetSceneEntity());
...
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::OnDeltaposRedSpin(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::OnDeltaposGreenSpin(NMHDR* pNMHDR, LRESULT* pResult) 
{
	NM_UPDOWN* nMUpDown = (NM_UPDOWN*)pNMHDR;
...
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::OnDeltaposBlueSpin(NMHDR* pNMHDR, LRESULT* pResult) 
{
	NM_UPDOWN* nMUpDown = (NM_UPDOWN*)pNMHDR;
...
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::OnDeltaposIntensitySpin(NMHDR* pNMHDR, LRESULT* pResult) 
{
	NM_UPDOWN* nMUpDown = (NM_UPDOWN*)pNMHDR;
...
//---------------------------------------------------------------------------
void DirectionalLightCustomControlsUI::OnColorPaletteButton() 
{
