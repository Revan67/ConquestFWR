...
CPP_DECL	void				__cdecl save										(const Scene* scene, const CharString filename, bool saveExtraData = false);
typedef		void				(__cdecl save_func_type)							(const Scene* scene, const CharString filename, bool saveExtraData = false);
