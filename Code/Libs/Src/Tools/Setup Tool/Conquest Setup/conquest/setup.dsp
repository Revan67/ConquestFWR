...
# ADD LINK32 hotsetup.lib winmm.lib version.lib lz32.lib comctl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /subsystem:windows /map /machine:I386 /nodefaultlib:"libcmt" /libpath:"..\hotsetup\libs\release" /libpath:"..\hotsetup\libs" /OPT:REF /VERBOSE:LIB
...
# ADD LINK32 hotsetup.lib winmm.lib version.lib lz32.lib comctl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:no /map /debug /machine:I386 /nodefaultlib:"libcmtd" /nodefaultlib:"libc" /pdbtype:sept /libpath:"..\hotsetup\libs\debug" /libpath:"..\hotsetup\libs"
# SUBTRACT LINK32 /pdb:none
