...
#define STR_LOCALIZE_LOCINSTR3				5
...
//
#define STR_UNSETUPSWITCH					219	// "/uninstall" flag to notify setup it is being run as an uninstal
#define STR_AUTORUNSWITCH					220	// "/autorun" flag to notify setup it has been run by the autorun

//
//Strings in the 300-399 range are used by the engine, but should be defined in the application's
//resource file(s)...
//
...
//
//Preview Include toggle
//
#define STR_ENABLE_PREVIEW				 314
