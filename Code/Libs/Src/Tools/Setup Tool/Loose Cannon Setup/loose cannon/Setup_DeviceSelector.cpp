...
void ProcessSelections(IDAComponent *Win, LPSTR iniFileName, bool useDefaultSettings)
{
	...
	WritePrivateProfileString("Video", "HardwareRender", (Configurable_Options[OPTION_HW_RENDERER][setting]?"on":"off"), iniFileName);
...
bool GetDeviceSelection(HWND hwnd, LPSTR iniFileName, LPSTR szFlags, bool forceConfigureWindow)
{
	char device[255+1], dc[64+1], did[64+1];
