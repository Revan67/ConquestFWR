...
@proto_27		TYPEDEF		PROTO STDCALL :PTR PANE_LIST
VFX_pane_list_refresh		PROTO		@proto_27

@proto_28		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :S32, :S32, :S32, :S32, :U32
VFX_line_draw		PROTO		@proto_28

@proto_29		TYPEDEF		PROTO STDCALL :PTR PANE, :PTR VFX_SHAPETABLE, :S32, :S32, :S32
VFX_shape_draw		PROTO		@proto_29

@proto_30		TYPEDEF		PROTO STDCALL :PTR U8
VFX_shape_lookaside		PROTO		@proto_30

@proto_31		TYPEDEF		PROTO STDCALL :PTR PANE, :PTR VFX_SHAPETABLE, :S32, :S32, :S32
VFX_shape_translate_draw		PROTO		@proto_31

@proto_32		TYPEDEF		PROTO STDCALL :PTR PANE, :PTR VFX_SHAPETABLE, :S32, :S32, :S32, :PTR , :S32, :S32, :S32, :U32
VFX_shape_transform		PROTO		@proto_32

@proto_33		TYPEDEF		PROTO STDCALL :PTR PANE, :PTR VFX_SHAPETABLE, :S32, :S32, :S32, :PTR , :S32, :S32, :S32, :U32, :PTR 
VFX_shape_area_translate		PROTO		@proto_33

@proto_34		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :U32
VFX_shape_remap_colors		PROTO		@proto_34

@proto_35		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :S32, :S32, :S32, :S32, :PTR VFX_RECT
VFX_shape_visible_rectangle		PROTO		@proto_35

@proto_36		TYPEDEF		PROTO STDCALL :PTR PANE, :U32, :S32, :S32, :PTR VFX_SHAPETABLE
VFX_shape_scan8		PROTO		@proto_36

@proto_37		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :S32
VFX_shape_bounds		PROTO		@proto_37

@proto_38		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :S32
VFX_shape_origin		PROTO		@proto_38

@proto_39		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :S32
VFX_shape_resolution		PROTO		@proto_39

@proto_40		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :S32
VFX_shape_minxy		PROTO		@proto_40

@proto_41		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :S32, :PTR VFX_RGB
VFX_shape_palette		PROTO		@proto_41

@proto_42		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :S32, :PTR VFX_CRGB
VFX_shape_colors		PROTO		@proto_42

@proto_43		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :S32, :PTR VFX_CRGB
VFX_shape_set_colors		PROTO		@proto_43

@proto_44		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE
VFX_shape_count		PROTO		@proto_44

@proto_45		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :PTR U32
VFX_shape_list		PROTO		@proto_45

@proto_46		TYPEDEF		PROTO STDCALL :PTR VFX_SHAPETABLE, :PTR U32
VFX_shape_palette_list		PROTO		@proto_46

@proto_47		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :S32, :U32
VFX_pixel_write		PROTO		@proto_47

@proto_48		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :S32
VFX_pixel_read		PROTO		@proto_48

@proto_49		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :S32, :S32, :S32, :U32
VFX_rectangle_hash		PROTO		@proto_49

@proto_50		TYPEDEF		PROTO STDCALL :PTR PANE, :U32
VFX_pane_wipe		PROTO		@proto_50

@proto_51		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :S32, :PTR PANE, :S32, :S32, :S32
VFX_pane_copy		PROTO		@proto_51

@proto_52		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :S32, :S32, :S32
VFX_pane_scroll		PROTO		@proto_52

@proto_53		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :S32, :S32, :S32, :U32
VFX_ellipse_draw		PROTO		@proto_53

@proto_54		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :S32, :S32, :S32, :U32
VFX_ellipse_fill		PROTO		@proto_54

@proto_55		TYPEDEF		PROTO STDCALL :PTR VFX_POINT, :PTR VFX_POINT, :PTR VFX_POINT, :S32, :S32, :S32
VFX_point_transform		PROTO		@proto_55

@proto_56		TYPEDEF		PROTO STDCALL :S32, :PTR F16, :PTR F16
VFX_Cos_Sin		PROTO		@proto_56

@proto_57		TYPEDEF		PROTO STDCALL :F16, :F16, :PTR F16
VFX_fixed_mul		PROTO		@proto_57

@proto_58		TYPEDEF		PROTO STDCALL :PTR VFX_FONT
VFX_font_height		PROTO		@proto_58

@proto_59		TYPEDEF		PROTO STDCALL :PTR VFX_FONT, :S32
VFX_character_width		PROTO		@proto_59

@proto_60		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :S32, :PTR VFX_FONT, :S32, :PTR 
VFX_character_draw		PROTO		@proto_60

@proto_61		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :S32, :PTR VFX_FONT, :PTR SBYTE, :PTR 
VFX_string_draw		PROTO		@proto_61

@proto_62		TYPEDEF		PROTO STDCALL :PTR PANE, :PTR 
VFX_ILBM_draw		PROTO		@proto_62

@proto_63		TYPEDEF		PROTO STDCALL :PTR , :PTR VFX_RGB
VFX_ILBM_palette		PROTO		@proto_63

@proto_64		TYPEDEF		PROTO STDCALL :PTR 
VFX_ILBM_resolution		PROTO		@proto_64

@proto_65		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :PTR 
VFX_PCX_draw		PROTO		@proto_65

@proto_66		TYPEDEF		PROTO STDCALL :PTR , :S32, :PTR VFX_RGB
VFX_PCX_palette		PROTO		@proto_66

@proto_67		TYPEDEF		PROTO STDCALL :PTR 
VFX_PCX_resolution		PROTO		@proto_67

@proto_68		TYPEDEF		PROTO STDCALL :PTR PANE, :PTR 
VFX_GIF_draw		PROTO		@proto_68

@proto_69		TYPEDEF		PROTO STDCALL :PTR , :PTR VFX_RGB
VFX_GIF_palette		PROTO		@proto_69

@proto_70		TYPEDEF		PROTO STDCALL :PTR 
VFX_GIF_resolution		PROTO		@proto_70

@proto_71		TYPEDEF		PROTO STDCALL :PTR PANE, :PTR U32
VFX_color_scan		PROTO		@proto_71

@proto_72		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :PTR SCRNVERTEX
VFX_flat_polygon		PROTO		@proto_72

@proto_73		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :PTR SCRNVERTEX
VFX_Gouraud_polygon		PROTO		@proto_73

@proto_74		TYPEDEF		PROTO STDCALL :PTR PANE, :F16, :S32, :PTR SCRNVERTEX
VFX_dithered_Gouraud_polygon		PROTO		@proto_74

@proto_75		TYPEDEF		PROTO STDCALL :PTR U8
VFX_map_lookaside		PROTO		@proto_75

@proto_76		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :PTR SCRNVERTEX, :PTR VFX_WINDOW, :U32
VFX_map_polygon		PROTO		@proto_76

@proto_77		TYPEDEF		PROTO STDCALL :PTR PANE, :S32, :PTR SCRNVERTEX, :PTR 
VFX_translate_polygon		PROTO		@proto_77

@proto_78		TYPEDEF		PROTO STDCALL :PTR PANE, :F16, :S32, :PTR SCRNVERTEX
VFX_illuminate_polygon		PROTO		@proto_78
...
IF 0
?ColorRefToPixel@@YIKK@Z PROTO SYSCALL :S32
ENDIF
...
SHAPETABLEHEADER STRUCT
version			DWORD ?
shape_count     DWORD ?
SHAPETABLEHEADER ENDS
;--------------------------------
...
;;DrawShapeUnclipped PROTO STDCALL  panep:PPANE, shape:PTR, hotx:DWORD, hoty:DWORD
...
ENDIF
                ...
                do_VFX_pixel_write              equ FALSE
                do_VFX_pixel_read               equ FALSE
                do_VFX_line_draw                equ FALSE
                do_VFX_rectangle_hash           equ FALSE
                do_VFX_shape_scan               equ FALSE
                do_VFX_shape_draw8              equ TRUE
                do_VFX_shape_draw               equ FALSE
                do_VFX_shape_visible_rectangle  equ FALSE
                do_VFX_shape_lookaside          equ FALSE
                do_VFX_shape_translate_draw     equ FALSE
                do_VFX_shape_transform          equ FALSE
                do_VFX_shape_area_translate     equ FALSE
                do_VFX_shape_remap_colors       equ FALSE
                do_VFX_pane_wipe                equ FALSE
                do_VFX_pane_copy                equ FALSE
                do_VFX_pane_scroll              equ FALSE
                do_VFX_ellipse_draw             equ FALSE
                do_VFX_ellipse_fill             equ FALSE
                do_VFX_point_transform          equ FALSE
                do_VFX_Cos_Sin                  equ FALSE
                do_VFX_fixed_mul                equ FALSE
                do_VFX_font_height              equ FALSE
                do_VFX_character_width          equ FALSE
                do_VFX_character_draw           equ FALSE
                do_VFX_string_draw              equ FALSE
                do_VFX_ILBM_draw                equ FALSE
                do_VFX_ILBM_palette             equ FALSE
                do_VFX_ILBM_resolution          equ FALSE
                do_VFX_PCX_draw                 equ FALSE
                do_VFX_PCX_palette              equ FALSE
                do_VFX_PCX_resolution           equ FALSE
                do_VFX_GIF_draw                 equ FALSE
                do_VFX_GIF_palette              equ FALSE
                do_VFX_GIF_resolution           equ FALSE
                do_VFX_shape_bounds             equ TRUE
                do_VFX_shape_origin             equ FALSE
                do_VFX_shape_resolution         equ FALSE
                do_VFX_shape_minxy              equ FALSE
                do_VFX_shape_palette            equ TRUE
                do_VFX_shape_colors             equ TRUE
                do_VFX_shape_set_colors         equ FALSE
                do_VFX_shape_count              equ FALSE
                do_VFX_shape_list               equ FALSE
                do_VFX_shape_palette_list       equ FALSE
                do_VFX_color_scan               equ FALSE
...
VFX_shape_palette2 PROC STDCALL USES ebx esi edi, \
                SHP_buffer:PTABLE, Shape_number:S32, Palette:PTR DWORD
...
__read_color:
				...
				add esi,4
				mov bl,cl
				and ecx,3F3F3F3Fh				; mask out top 2 bits
				shr ecx,6
				;
				; color is now in 8-8-8 (00bbggrr) format
				;
				call	?ColorRefToPixel@@YIKK@Z				; use fastcall convention (ecx is parm 0)
...
DrawShapeUnclipped PROC PRIVATE USES ebx esi edi es,\
...
DrawShapeUnclipped \
            ...
            ENDIF	; do_VFX_shape_draw

;----------------------------------------------------------------------------
; 8 bit version of VFX_shape_draw(), does no clipping
;
            IF do_VFX_shape_draw8

VFX_shape_draw_unclipped8 PROC STDCALL USES ebx esi edi es,\
...
;----------------------------------------------------------------------------
;
VFX_shape_draw8 PROC STDCALL USES ebx esi edi es,\
        ...
        ; call DrawShapeUnclipped() with to draw the shape, then exit
            ...
            INVOKE  VFX_shape_draw_unclipped8, panep, shape, hotX, hotY, CP_W
            jmp     Exit
...
;;            mov shape_color_src,esi
            ...
            invoke VFX_shape_palette2,shape_table,shape_number,OFFSET shape_translate
...
VFX_shape_scan8 PROC STDCALL USES ebx esi edi es,\
...
__translate_4bpp:
                ...
                test eax,0FF000000h				;is alpha 0?
                je __skip_4bpp
                mov DWORD PTR [edi],eax
__skip_4bpp:
                inc esi
                add edi,pixel_pitch
                loop __translate_4bpp
                jmp __next_translate
...
VFX_shape_bounds PROC STDCALL USES ebx esi edi es, \
				...
				mov esi,[SHP_buffer]
				mov eax,[esi].SHAPETABLEHEADER.shape_count
				cmp eax,Shape_number
				jle __bounds_error
