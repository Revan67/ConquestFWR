...
DXDEC S32  VFXAPI VFX_set_display_mode      (S32             display_size_X,
                                             S32             display_size_Y,
                                             S32             display_bpp,
                                             S32             initial_window_mode,
                                             S32             allow_mode_switch);

DXDEC void VFXAPI VFX_lock_window_surface   (VFX_WINDOW     *window, 
                                             S32             surface);

DXDEC void VFXAPI VFX_unlock_window_surface (VFX_WINDOW     *window, 
                                             S32             perform_flip);

DXDEC void VFXAPI VFX_set_palette_entry     (S32             index,
                                             VFX_RGB        *entry,
                                             S32             wait_flag);
                                               
DXDEC void VFXAPI VFX_get_palette_entry     (S32             index,
                                             VFX_RGB        *entry);

DXDEC void VFXAPI VFX_set_palette_range     (S32             index,
                                             S32             num_entries,
                                             VFX_RGB        *entry_list,
                                             S32             wait_flag);
                                               
DXDEC void VFXAPI VFX_get_palette_range     (S32             index,
                                             S32             num_entries,
                                             VFX_RGB        *entry_list);

DXDEC U32  VFXAPI VFX_pixel_value           (VFX_RGB        *VFX_RGB);

DXDEC U32  VFXAPI VFX_triplet_value         (U32             r, 
                                             U32             g, 
                                             U32             b);

DXDEC VFX_RGB * 
           VFXAPI VFX_RGB_value             (U32             native_pixel);

DXDEC VFX_RGB *
           VFXAPI VFX_color_to_RGB          (U32             color);

DXDEC U32  VFXAPI VFX_stencil_size          (VFX_WINDOW     *source, 
                                             U32             transparent_color);

DXDEC VFX_STENCIL * 
           VFXAPI VFX_stencil_construct    (VFX_WINDOW      *source, 
                                            VFX_STENCIL     *dest, 
                                            U32              transparent_color);

DXDEC void VFXAPI VFX_stencil_destroy       (VFX_STENCIL    *stencil);

DXDEC VFX_WINDOW * 
           VFXAPI VFX_window_construct      (S32             width, 
                                             S32             height);

DXDEC void * 
           VFXAPI VFX_assign_window_buffer  (VFX_WINDOW     *window,
                                             void           *buffer,
                                             S32             pitch);

DXDEC void VFXAPI VFX_window_destroy        (VFX_WINDOW     *window);

DXDEC PANE * 
           VFXAPI VFX_pane_construct        (VFX_WINDOW     *window, 
                                             S32             x0, 
                                             S32             y0, 
                                             S32             x1, 
                                             S32             y1);

DXDEC void VFXAPI VFX_pane_destroy          (PANE           *pane);

DXDEC PANE_LIST *     
           VFXAPI VFX_pane_list_construct   (S32             n_entries);

DXDEC void VFXAPI VFX_pane_list_destroy     (PANE_LIST      *list);

DXDEC void VFXAPI VFX_pane_list_clear       (PANE_LIST      *list);

DXDEC S32  VFXAPI VFX_pane_list_add         (PANE_LIST      *list, 
                                             PANE           *target);

DXDEC S32  VFXAPI VFX_pane_list_add_area    (PANE_LIST      *list, 
                                             VFX_WINDOW     *window, 
                                             S32             x0, 
                                             S32             y0,
                                             S32             x1, 
...
DXDEC void VFXAPI VFX_pane_list_delete_entry(PANE_LIST      *list, 
                                             S32             entry_num);

DXDEC S32  VFXAPI VFX_pane_list_identify_point
                                            (PANE_LIST      *list,
                                             S32             x,
                                             S32             y);

DXDEC PANE *
           VFXAPI VFX_pane_list_get_entry   (PANE_LIST      *list,
                                             S32             entry_num);

DXDEC void VFXAPI VFX_pane_list_refresh     (PANE_LIST      *list);

//
// Device-independent VFX API functions (WINVFXxx.ASM)
//

DXDEC S32  VFXAPI VFX_line_draw             (PANE           *pane, 
                                             S32             x0, 
                                             S32             y0, 
                                             S32             x1, 
                                             S32             y1, 
...
DXDEC void VFXAPI VFX_shape_draw            (PANE           *pane, 
                                             VFX_SHAPETABLE *shape_table,
                                             S32             shape_number, 
                                             S32             hotX, 
                                             S32             hotY);

DXDEC void VFXAPI VFX_shape_lookaside       (U8             *table);

DXDEC void VFXAPI VFX_shape_translate_draw  (PANE           *pane, 
                                             VFX_SHAPETABLE *shape_table,
                                             S32             shape_number, 
                                             S32             hotX, 
                                             S32             hotY);

DXDEC void VFXAPI VFX_shape_transform       (PANE           *pane,
                                             VFX_SHAPETABLE *shape_table, 
                                             S32             shape_number, 
                                             S32             hotX, 
                                             S32             hotY,
...
DXDEC void VFXAPI VFX_shape_area_translate  (PANE           *pane,
                                             VFX_SHAPETABLE *shape_table, 
                                             S32             shape_number, 
                                             S32             hotX, 
                                             S32             hotY,
...
DXDEC void VFXAPI VFX_shape_remap_colors    (VFX_SHAPETABLE *shape_table,
                                             U32             shape_number);

DXDEC void VFXAPI VFX_shape_visible_rectangle
                                            (VFX_SHAPETABLE *shape_table,
                                             S32             shape_number, 
                                             S32             hotX, 
                                             S32             hotY,
...
DXDEC S32  VFXAPI VFX_shape_point_opacity   (VFX_SHAPETABLE *shape_table,
                                             S32             shape_number,
                                             S32             hotX,  
                                             S32             hotY,
                                             S32             testX,  
...
DXDEC S32  VFXAPI VFX_shape_scan            (PANE           *pane, 
                                             U32             transparent_color,
                                             S32             hotX, 
                                             S32             hotY, 
                                             VFX_SHAPETABLE *shape_table);

DXDEC S32  VFXAPI VFX_shape_bounds          (VFX_SHAPETABLE *shape_table, 
                                             S32             shape_num);

DXDEC S32  VFXAPI VFX_shape_origin          (VFX_SHAPETABLE *shape_table, 
                                             S32             shape_num);

DXDEC S32  VFXAPI VFX_shape_resolution      (VFX_SHAPETABLE *shape_table, 
                                             S32             shape_num);

DXDEC S32  VFXAPI VFX_shape_minxy           (VFX_SHAPETABLE *shape_table, 
                                             S32             shape_num);

DXDEC void VFXAPI VFX_shape_palette         (VFX_SHAPETABLE *shape_table, 
                                             S32             shape_num,
                                             VFX_RGB        *palette);

DXDEC S32  VFXAPI VFX_shape_colors          (VFX_SHAPETABLE *shape_table, 
                                             S32             shape_num,
                                             VFX_CRGB       *colors);

DXDEC S32  VFXAPI VFX_shape_set_colors      (VFX_SHAPETABLE *shape_table, 
                                             S32             shape_number,
                                             VFX_CRGB       *colors);

DXDEC S32  VFXAPI VFX_shape_count           (VFX_SHAPETABLE *shape_table);

DXDEC S32  VFXAPI VFX_shape_list            (VFX_SHAPETABLE *shape_table, 
                                             U32            *index_list);

DXDEC S32  VFXAPI VFX_shape_palette_list    (VFX_SHAPETABLE *shape_table, 
                                             U32            *index_list);

DXDEC U32  VFXAPI VFX_pixel_write           (PANE           *pane, 
                                             S32             x, 
                                             S32             y, 
                                             U32             color);

DXDEC U32  VFXAPI VFX_pixel_read            (PANE           *pane, 
                                             S32             x, 
                                             S32             y);

DXDEC S32  VFXAPI VFX_rectangle_hash        (PANE           *pane, 
                                             S32             x0, 
                                             S32             y0,
                                             S32             x1, 
                                             S32             y1, 
...
DXDEC S32  VFXAPI VFX_pane_wipe             (PANE           *pane, 
                                             U32             color);

DXDEC S32  VFXAPI VFX_pane_copy             (PANE           *source, 
                                             S32             sx, 
                                             S32             sy,
                                             PANE           *target, 
                                             S32             tx, 
...
DXDEC S32  VFXAPI VFX_pane_scroll           (PANE           *pane, 
                                             S32             dx, 
                                             S32             dy,
                                             S32             mode, 
                                             S32             parm);

DXDEC void VFXAPI VFX_ellipse_draw          (PANE           *pane, 
                                             S32             xc, 
                                             S32             yc, 
                                             S32             width, 
                                             S32             height, 
...
DXDEC void VFXAPI VFX_ellipse_fill          (PANE           *pane, 
                                             S32             xc, 
                                             S32             yc, 
                                             S32             width, 
                                             S32             height, 
...
DXDEC void VFXAPI VFX_point_transform       (VFX_POINT      *in, 
                                             VFX_POINT      *out, 
                                             VFX_POINT      *origin,
                                             S32             rot, 
                                             S32             x_scale, 
...
DXDEC void VFXAPI VFX_Cos_Sin               (S32             angle, 
                                             F16            *cos, 
                                             F16            *sin);

DXDEC void VFXAPI VFX_fixed_mul             (F16             M1, 
                                             F16             M2,
                                             F16            *result);

DXDEC S32  VFXAPI VFX_font_height           (VFX_FONT       *font);

DXDEC S32  VFXAPI VFX_character_width       (VFX_FONT       *font, 
                                             S32             character);

DXDEC S32  VFXAPI VFX_character_draw        (PANE           *pane, 
                                             S32             x, 
                                             S32             y, 
                                             VFX_FONT       *font,
                                             S32             character, 
...
DXDEC void VFXAPI VFX_string_draw           (PANE           *pane, 
                                             S32             x, 
                                             S32             y, 
                                             VFX_FONT       *font,
                                             char           *string, 
...
DXDEC S32  VFXAPI VFX_ILBM_draw             (PANE           *pane, 
                                             void           *ILBM_buffer);

DXDEC void VFXAPI VFX_ILBM_palette          (void           *ILBM_buffer, 
                                             VFX_RGB        *palette);

DXDEC S32  VFXAPI VFX_ILBM_resolution       (void           *ILBM_buffer);

DXDEC void VFXAPI VFX_PCX_draw              (PANE           *pane, 
                                             S32             PCX_file_size, 
                                             void           *PCX_buffer);

DXDEC void VFXAPI VFX_PCX_palette           (void           *PCX_buffer, 
                                             S32             PCX_file_size,
                                             VFX_RGB        *palette);

DXDEC S32  VFXAPI VFX_PCX_resolution        (void           *PCX_buffer);

DXDEC S32  VFXAPI VFX_GIF_draw              (PANE           *pane, 
                                             void           *GIF_buffer);

DXDEC void VFXAPI VFX_GIF_palette           (void           *GIF_buffer, 
                                             VFX_RGB        *palette);

DXDEC S32  VFXAPI VFX_GIF_resolution        (void           *GIF_buffer);

DXDEC S32  VFXAPI VFX_color_scan            (PANE           *pane, 
                                             U32            *colors);
...
DXDEC void VFXAPI VFX_flat_polygon          (PANE           *pane, 
                                             S32             vcnt, 
                                             SCRNVERTEX     *vlist);

DXDEC void VFXAPI VFX_Gouraud_polygon       (PANE           *pane, 
                                             S32             vcnt, 
                                             SCRNVERTEX     *vlist);

DXDEC void VFXAPI VFX_dithered_Gouraud_polygon
                                            (PANE           *pane, 
                                             F16             dither_amount, 
                                             S32             vcnt, 
                                             SCRNVERTEX     *vlist);

DXDEC void VFXAPI VFX_map_lookaside         (U8             *table);

DXDEC void VFXAPI VFX_map_polygon           (PANE           *pane, 
                                             S32             vcnt, 
                                             SCRNVERTEX     *vlist,
                                             VFX_WINDOW     *texture, 
                                             U32             flags);

DXDEC void VFXAPI VFX_translate_polygon     (PANE           *pane, 
                                             S32             vcnt, 
                                             SCRNVERTEX     *vlist,
                                             void           *lookaside);

DXDEC void VFXAPI VFX_illuminate_polygon    (PANE           *pane, 
                                             F16             dither_amount, 
                                             S32             vcnt, 
                                             SCRNVERTEX     *vlist);
