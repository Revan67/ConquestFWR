...
{
	// Full retail body restored 2026-08-29. The IExtent mesh API it needs
	// (owner->GetMeshChain / GetMeshInfoTree) was restored to ObjectExtent in the same change.
	CQASSERT(_owner);
...
//	race = mdata.pSaveData->race;
	...
	// (end of restored retail InitExplosion body)
	return 1;
}
//----------------------------------------------------------------------------------
//
