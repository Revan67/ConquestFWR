...
/*
   ...
   $Header: /EffectEd/Src/SuperTrans.cpp 1     7/18/03 11:54a Tmauer $
...
//-------------------------------------------------------------------
//
void TRANSFORM::Get4x4(SINGLE *array)
{
	...
	array[12] = translation.x;
	array[13] = translation.y;
	array[14] = translation.z;
	array[15] = 1.0;
}
//-------------------------------------------------------------------
//
