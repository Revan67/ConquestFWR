...
public:
	...
	*/
	TIXML_QRESULT QueryIntValue( int* value ) const;
	TIXML_QRESULT QueryDoubleValue( double* value ) const;
	TIXML_QRESULT QueryUnsignedIntValue( unsigned long* value ) const;
...
public:
	...
	*/	
	...
	TIXML_QRESULT QueryIntAttribute( const char* name, int* value ) const;
	TIXML_QRESULT QueryDoubleAttribute( const char* name, double* value ) const;
	TIXML_QRESULT QueryUnsignedIntValue( const char* name, unsigned long* value ) const;
	TIXML_QRESULT QueryUnicodeValue( const char* name, wchar_t** ) const;

	TIXML_QRESULT QueryIntAttribute( const char* name, long* value ) const
	{
		return QueryIntAttribute(name, (int*)value );
	}

	TIXML_QRESULT QueryFloatAttribute( const char* name, float* fvalue ) const
	{
		double d;
		if( QueryDoubleAttribute(name,&d) == TIXML_SUCCESS )
		{
			*fvalue = d;
	...
	*/
	...
	unsigned long GetAttributeUnsignedLong( const char* _name );
	long          GetAttributeLong( const char* _name );
	double        GetAttributeDouble( const char* _name );
	float         GetAttributeFloat( const char* _name );
