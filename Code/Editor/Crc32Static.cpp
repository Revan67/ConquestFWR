...
#define MAKEQWORD(a, b)	\
	((__int64)( ((__int64) ((DWORD) (a))) << 32 | ((DWORD) (b))))

#define LODWORD(l) \
	((DWORD)(l))
#define HIDWORD(l) \
	((DWORD)(((__int64)(l) >> 32) & 0xFFFFFFFF))
...
//***********************************************
bool CCrc32Static::GetFileSizeQW(const HANDLE hFile, __int64 &qwSize)
{
...
//***********************************************
DWORD CCrc32Static::BufferCrc32(LPVOID pBuffer, DWORD dwSize, DWORD &dwCrc32)
{
	DWORD dwErrorCode = NO_ERROR;

	dwCrc32 = 0xFFFFFFFF;

	BYTE* pBytes = static_cast<BYTE*>(pBuffer);

	try
	{
		while(dwSize)
		{
			CalcCrc32((BYTE)*pBytes, dwCrc32);
			pBytes++;
			dwSize--;
		}
	}
...
DWORD CCrc32Static::FileCrc32Filemap(LPCTSTR szFilename, DWORD &dwCrc32)
{
	...
	try
	{
		...
		{
			__int64 qwFileSize = 0, qwFileOffset = 0;
