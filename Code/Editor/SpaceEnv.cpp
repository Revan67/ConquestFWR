...
// TODO: do we need a IVertexBufferOwner? #include "IVertexBuffer.h"
#include "Startup.h"
...
// see RenderSystem.cpp
void __stdcall SetupDiffuseBlend( U32 irp_texture_id, bool bClamp );

//----------------------------------------------------------------------------
//----------------------------------------------------------------------------
//
struct DACOM_NO_VTABLE SpaceEnvironment : public IEventCallback, IBackground // TODO: do we need a IVertexBufferOwner? , IVertexBufferOwner
{
	//
...
//	}
	...
	{
// todo: do we need a VB manager?		vb_mgr->Add(this);
	}
...
// TODO: do we need a IVertexBufferOwner? 	virtual void RestoreVertexBuffers();
};

// TODO: do we need a IVertexBufferOwner? void SpaceEnvironment::RestoreVertexBuffers()
// TODO: do we need a IVertexBufferOwner? {
// TODO: do we need a IVertexBufferOwner? 	for(U32 i = 0; i < MAX_BG_CHILD; ++ i)
// TODO: do we need a IVertexBufferOwner? 	{
// TODO: do we need a IVertexBufferOwner? 		if(vb_handle[i])
// TODO: do we need a IVertexBufferOwner? 		{
// TODO: do we need a IVertexBufferOwner? 			PIPE->destroy_vertex_buffer(vb_handle[i]);
// TODO: do we need a IVertexBufferOwner? 			vb_handle[i] = 0;
// TODO: do we need a IVertexBufferOwner? 		}
// TODO: do we need a IVertexBufferOwner? 	}
// TODO: do we need a IVertexBufferOwner? }
//------------------------------------------------------------------------
...
{
// todo: do we need a VB manager?	vb_mgr->Delete(this);
...
void SpaceEnvironment::RenderNeb (void)
{
	if (CQRENDERFLAGS.bSoftwareRenderer)
		return;
	if (CQRENDERFLAGS.bBackground==0)
		return;
